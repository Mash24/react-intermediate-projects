...
function App() {
  ...
  return (
    <>
      ...
      <div className="bg-white/10 p-8 rounded-lg shadow-lg text-center">
        <button 
        ...
        <p className="mt-4 text-gray-300">
          Edit <code className="font-mono bg-gray-700 px-1 py-0.5 rounded">src/App.jsx</code> and save to test HMR
        </p>
      </div>
